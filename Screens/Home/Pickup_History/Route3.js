...
const Route3 = () => {
  ...
  const getrouterequest = () => {
    ...
    let path = Filter_Dates
      ? `recycles?route_id=3&status=Completed&driver_id=${Profile.id}&created_at_from=${Filter_Dates}&created_at_to=${Filter_Dates}&limit=999999`
      : `recycles?route_id=3&status=Completed&driver_id=${Profile.id}&limit=999999`;
      ...
      return (
        ...
        >
          <Text style={GlobalStyles.HeaderText}>
            {strings.NOCOMPELTEDREQONROUT} 3
          </Text>
        </View>
      );
    }
